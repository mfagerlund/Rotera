...
class TestNewConstraintRegistry:
    ...
    def test_get_new_constraint_classes(self):
        ...
        assert ConstraintRegistry.get_constraint_class("collinear") == CollinearConstraint
        assert ConstraintRegistry.get_constraint_class("perpendicular") == PerpendicularConstraint
        ...
        assert ConstraintRegistry.get_constraint_class("distance_ratio") == FixedDistanceRatioConstraint
...
class TestConstraintCombinations:
    ...
    def test_mixed_constraint_validation(self):
        ...
        constraints.append(PerpendicularConstraint(
            line1_wp_a="wp4", line1_wp_b="wp5",
            line2_wp_a="wp6", line2_wp_b="wp7"
        ))
        constraints.append(ParallelConstraint(
            line1_wp_a="wp8", line1_wp_b="wp9",
            line2_wp_a="wp10", line2_wp_b="wp11"
        ))
        constraints.append(AngleConstraint(
            line1_wp_a="wp12", line1_wp_b="wp13",
            line2_wp_a="wp14", line2_wp_b="wp15",
            angle_degrees=45.0
        ))
        constraints.append(FixedDistanceRatioConstraint(
            line1_wp_a="wp16", line1_wp_b="wp17",
            line2_wp_a="wp18", line2_wp_b="wp19",
            ratio=2.0
        ))
        ...
        expected_types = ["collinear", "perpendicular", "parallel", "angle", "distance_ratio"]
