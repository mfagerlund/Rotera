...
interface EnhancedWorldPointPanelProps {
...
export const EnhancedWorldPointPanel: React.FC<EnhancedWorldPointPanelProps> = ({
  worldPoints,
  constraints,
...
export default EnhancedWorldPointPanel