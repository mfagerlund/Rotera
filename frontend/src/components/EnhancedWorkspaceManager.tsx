...
export const EnhancedWorkspaceSwitcher: React.FC<WorkspaceSwitcherProps> = ({
  currentWorkspace,
  onWorkspaceChange,
  imageHasContent,
  worldHasContent,
...
export const EnhancedWorkspaceManager: React.FC<WorkspaceManagerProps> = ({
  workspaceState,
...
export default EnhancedWorkspaceManager